...
ActiveRecord::Schema.define(version: 2020_11_11_095452) do
  ...
  create_table "sdg_goal_translations", force: :cascade do |t|
    ...
    t.string "title"
    t.text "description"
    t.index ["locale"], name: "index_sdg_goal_translations_on_locale"
    t.index ["sdg_goal_id"], name: "index_sdg_goal_translations_on_sdg_goal_id"
    t.index ["title", "locale"], name: "index_sdg_goal_translations_on_title_and_locale", unique: true
  end
