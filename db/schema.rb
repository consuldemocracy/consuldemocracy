...
ActiveRecord::Schema.define(version: 20190619133547) do
  ...
  create_table "budget_investment_change_logs", id: :serial, force: :cascade do |t|
    t.integer "investment_id"
    t.integer "author_id"
    t.string "field"
    t.string "new_value"
  ...
  create_table "budget_investment_milestone_translations", id: :serial, force: :cascade do |t|
    ...
    t.string "title"
    t.text "description"
    t.index ["budget_investment_milestone_id"], name: "index_6770e7675fe296cf87aa0fd90492c141b5269e0b"
    t.index ["locale"], name: "index_budget_investment_milestone_translations_on_locale"
  end

  create_table "budget_investment_milestones", id: :serial, force: :cascade do |t|
    t.integer "investment_id"
    t.string "title", limit: 80
    t.text "description"
    t.datetime "created_at", null: false
    ...
    t.integer "status_id"
    t.index ["status_id"], name: "index_budget_investment_milestones_on_status_id"
  end

  create_table "budget_investment_statuses", id: :serial, force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.datetime "hidden_at"
    t.datetime "created_at", null: false
  ...
  create_table "budget_rol_assignments", id: :serial, force: :cascade do |t|
    t.integer "budget_id"
    t.integer "user_id"
    t.string "rol"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["budget_id"], name: "index_budget_rol_assignments_on_budget_id"
    t.index ["user_id"], name: "index_budget_rol_assignments_on_user_id"
  end

  create_table "budget_tracker_assignments", id: :serial, force: :cascade do |t|
    t.integer "tracker_id"
    t.integer "investment_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["investment_id"], name: "index_budget_tracker_assignments_on_investment_id"
    t.index ["tracker_id"], name: "index_budget_tracker_assignments_on_tracker_id"
  end

  create_table "budget_trackers", id: :serial, force: :cascade do |t|
    t.integer "budget_id"
    t.integer "tracker_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["budget_id"], name: "index_budget_trackers_on_budget_id"
    t.index ["tracker_id"], name: "index_budget_trackers_on_tracker_id"
  end
  ...
  create_table "download_settings", id: :serial, force: :cascade do |t|
    ...
    t.index ["name_model", "name_field", "config"], name: "index_download_settings_on_name_model_and_name_field_and_config", unique: true
  end
  ...
  create_table "legislation_people_proposals", id: :serial, force: :cascade do |t|
    t.integer "legislation_process_id"
    t.string "title", limit: 80
    t.text "description"
    t.integer "author_id"
    ...
    t.string "youtube"
    t.string "website"
    t.index ["cached_votes_score"], name: "index_legislation_people_proposals_on_cached_votes_score"
  end
  ...
  create_table "poll_pair_answers", id: :serial, force: :cascade do |t|
    t.integer "question_id"
    t.integer "author_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["answer_left_id"], name: "index_poll_pair_answers_on_answer_left_id"
    t.index ["answer_rigth_id"], name: "index_poll_pair_answers_on_answer_rigth_id"
    t.index ["author_id"], name: "index_poll_pair_answers_on_author_id"
    t.index ["question_id"], name: "index_poll_pair_answers_on_question_id"
  end
  ...
  create_table "votation_set_answers", id: :serial, force: :cascade do |t|
    t.integer "author_id"
    t.integer "votation_type_id"
    t.string "answer"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["author_id"], name: "index_votation_set_answers_on_author_id"
    t.index ["votation_type_id"], name: "index_votation_set_answers_on_votation_type_id"
  end

  create_table "votation_types", id: :serial, force: :cascade do |t|
