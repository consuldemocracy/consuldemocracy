...
ActiveRecord::Schema.define(version: 20160622112803) do
  ...
  add_index "ballot_lines", ["ballot_id", "spending_proposal_id"], name: "index_ballot_lines_on_ballot_id_and_spending_proposal_id", using: :btree
