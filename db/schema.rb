...
ActiveRecord::Schema.define(version: 20171102144542) do
  ...
  add_index "poll_partial_results", ["booth_assignment_id", "created_at"], name: "index_poll_partial_results_on_booth_assignment_and_date", using: :btree
