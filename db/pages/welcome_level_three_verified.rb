if SiteCustomization::Page.find_by(slug: "welcome_level_three_verified")&.translations&.find_by(locale: I18n.locale).nil?
  page = SiteCustomization::Page.find_by(slug: "welcome_level_three_verified") || SiteCustomization::Page.new(slug: "welcome_level_three_verified", status: "published")
