    ...
    process = Legislation::Process.create!(
      ...
      homepage: <<~HOMEPAGE,
        `<p>Participation in the city has a few rules and guidelines. These are:</p>
         ...
         2) Be concise. We value short and concise contributions, which will positively affect the
         chances of proposals being integrated in the Strategic Mobility Plan 2025-2035.
         3) No discrimination. Offensive languages will not be tolerated and comments.</li>
         </ol>`
      HOMEPAGE
      additional_info: "",
      start_date: 12.days.ago,
