section "Creating DEMO collaborative legislation" do
  ...
  section "Legislation Process 1" do
    #
  ...
  section "Legislation Process 2" do
    #
  ...
  section "Legislation Process 3" do
    #
    # Legislation Process 3
    #
  ...
  section "Legislation Process 4" do

    #
    # Legislation Process 4
    #
    process = Legislation::Process.create!(title: "Strategic Mobility Plan 2025-2035",
                                           summary: "The Strategic Mobility Plan 2025-2035 will be written together with our citizens.\r\n",
                                           description: "The Strategic Mobility Plan 2025-2035 will be written together with our citizens. You can participate in the drafting of the Plan during three consecutive phases:\r\n1. Join the discussion about what are the most important mobility themes for the city\r\n2. Submit proposals or ideas for Mobility projects or regulations in the city\r\n3. Comment on the first and second draft of the Strategic Mobility Plan 2025-2035\r\n",
                                           homepage: "<p>Participation in the city has a few rules and guidelines. These are:</p>
                                            <ol>
                                            <li>What happens with my input? Your input will be used to write up the Strategic Mobility Plan 2025-2035, as long as the suggestions, proposals and comments are feasible and fit within the wider Mobility Framework of the city. Participants will receive structural feedback before and after each phase of the process.</li>
                                            <li>What is the Strategic Mobility Plan about? The Strategic Mobility Plan 2025-2035 will define the priorities and policy choices of the city for the next ten years. It will define sustainability variables and projects, determine which modes of transport and which districts of the city get prioritized, and it will set a timeline for completion of projects</li>
                                            <li>Are there any rules for participation? Yes, we carefully enforce certain rules for participation</li>
                                            <li>Collaboration. It is important to look at other people's contribution. We will look at everything but will eventually accept proposals with the most support and/or votes. 2) Be concise. We value short and concise contributions, which will positively affect the chances of proposals being integrated in the Strategic Mobility Plan 2025-2035. 3) No discrimination. Offensive languages will not be tolerated and comments.</li>
                                            </ol>",
                                           additional_info: "",
                                           start_date: 12.days.ago,
                                           end_date: 6.months.from_now,
    ...
    document = Rack::Test::UploadedFile.new(Rails.root.join("db", "demo_seeds", "documents", "legislation", "processes", "eurocities-policy-statement-2024.pdf"))
    ...
    # Proposal 1
    author = users.sample
    proposal = process.proposals.create!(title: "Shared electric cars in Northern districts",
                                summary: "I propose the installation of an electric car sharing station within our neighborhood. With the growing demand for sustainable transportation and the increasing number of residents prioritizing enviro",
                                description: "<p>I propose the installation of an electric car sharing station within our neighborhood. With the growing demand for sustainable transportation and the increasing number of residents prioritizing environmentally conscious choices, a car sharing station would offer an affordable, practical, and eco-friendly alternative to car ownership. It would significantly reduce traffic congestion, lower carbon emissions, and support the city's climate goals, while also providing residents—especially those without personal vehicles—convenient access to reliable transportation for errands, appointments, and daily commutes.</p><p>I recommend the station be located in a central, accessible area near public transit lines and residential buildings, ensuring it serves the broadest possible portion of the community. This initiative aligns with broader trends in urban mobility and sustainability, and I believe our neighborhood can be a model for future development. I encourage the municipality to collaborate with electric car sharing providers and explore potential grants or incentives to support this project. I, along with many fellow residents, would be eager to support and utilize such a service.</p>\r\n",
    ...
    comment = proposal.comments.create!(body: "Thanks to all for supporting my proposal!", user_id: author.id, created_at: 6.days.ago)
    up_voters = users.sample(1)
    up_voters.each do |voter|
      comment.vote_by(voter: voter, vote: true)
    end
    comment.update(updated_at: 1.days.ago)
    ...
    # Question 1
    question = process.questions.create!(title: "What do you think are the most important challenges of mobility in our city?\r\n",
                                         author_id: 1,
                                         created_at: 1.week.ago)
    question.question_options.create!(value: "Transport hubs and timelines and not well connected")
    question.question_options.create!(value: "Limited capacity of public transport")
    question.question_options.create!(value: "High congestion of mobility networks during busy hours")
    question.question_options.create!(value: "Limited accessibility of private mobility for low-income groups")
    question.question_options.create!(value: "Underperformance on sustainability goals")

    comment = question.comments.create!(body: "Buses and train stations are too far apart in the East district!",
                                        user_id: 12,
                                        created_at: 6.days.ago)
    up_voters = users.sample(2)
    up_voters.each do |voter|
    ...
    comment = question.comments.create!(body: "The city needs high ambitions when it comes to climate policies",
                                        user_id: 8,
                                        created_at: 6.days.ago)
    up_voters = users.sample(1)
    up_voters.each do |voter|
    ...
    # Question 2
    question = process.questions.create!(title: "Which modes of transport should have priority in the city?\r\n",
                                         author_id: 1,
                                         created_at: 1.week.ago)
    ...
    comment = question.comments.create!(body: "Tram is the oldest and most original form of transport in this city, that's why we should invest in it",
                                        user_id: 3,
                                        created_at: 6.days.ago)
    up_voters = users.sample(1)
    up_voters.each do |voter|
    ...
    comment = question.comments.create!(body: "We need more metro stations to facilitate fast mobility across the city's districts including outskirts!",
                                        user_id: 4,
                                        created_at: 6.days.ago)
    up_voters = users.sample(1)
    up_voters.each do |voter|
    ...
    # Question 3
    question = process.questions.create!(title: "Which of the current projects of the city do you see as promising?\r\n",
                                         author_id: 1,
                                         created_at: 1.week.ago)
    question.question_options.create!(value: "15-Minute City Plan")
    question.question_options.create!(value: "Development of all-in-1 public transport mobile application")
    question.question_options.create!(value: "Redevelopment of central station into modern and central transport hub")
    question.question_options.create!(value: "Bike Only Streets Plan")
    question.question_options.create!(value: "District-based mobility")

    comment = question.comments.create!(body: "Bike Only Streets is already a working concept in cities like Valencia, Spain, and Montreal, Canada",
                                        user_id: 5,
                                        created_at: 6.days.ago)
    up_voters = users.sample(2)
    up_voters.each do |voter|
    ...
    comment = question.comments.create!(body: "Districts should become mobility centers in themselves because local communities will benefit the most from that",
                                        user_id: 7,
                                        created_at: 6.days.ago)
    up_voters = users.sample(1)
    up_voters.each do |voter|
    ...
    body = File.read(Rails.root.join("db", "demo_seeds", "documents", "legislation", "processes", "draft-mobility.html"))
    ...
    annotation = draft.annotations.create!(quote: "STRATEGIC MOBILITY PLAN 2025-2035",
                                           ranges: [{
                                                      "start" => "/p[1]",
                                                      "startOffset" => 0,
                                                      "end" => "/p[1]",
                                           ...
                                           text: "Maybe we can give it a better sounding name, like Mobility and Transport for All, Sustainable and Efficient. How about that?",
                                           author_id: 3,
                                           range_start: "/p[1]",
    ...
    annotation = draft.annotations.create!(quote: "In five years, zero-emission mobility",
                                           ranges: [{
                                                      "start" => "/p[3]",
                                                      "startOffset" => 0,
                                                      "end" => "/p[3]",
                                           ...
                                           text: "I think this is a very good ambition but I think the texts lacks sufficient proposals to make this a reality",
                                           author_id: 3,
                                           range_start: "/p[3]",
                                           range_start_offset: 0,
                                           range_end: "/p[3]",
                                           ...
                                           created_at: 9.days.ago,
                                           updated_at: 9.days.ago)
    annotation = draft.annotations.create!(quote: "Eurocities manifesto",
                                           ranges: [{
                                                      "start" => "/p[5]",
                                                      "startOffset" => 20,
                                                      "end" => "/p[5]",
                                           ...
                                           text: "If you read the manifesto, there is more inspiration, also about transitioning car mobility into zero-cost emission sectors and concrete policy proposals on how to accomplish that.",
                                           author_id: 3,
                                           range_start: "/p[5]",
                                           ...
                                           created_at: 9.days.ago,
                                           updated_at: 9.days.ago)
    annotation = draft.annotations.create!(quote: "climate, road safety, air quality, noise",
                                           ranges: [{
                                                      "start" => "/p[2]",
                                                      "startOffset" => 340,
                                                      "end" => "/p[2]",
                                           ...
                                           context: "The task of the next EU policymakers will revolve around keeping the EU on track to meet its targets for 2030 and beyond in terms of <span class=annotator>climate, road safety, air quality, noise</span> and other Green Deal objectives.",
                                           created_at: 9.days.ago,
                                           updated_at: 9.days.ago)
    annotation = draft.annotations.create!(quote: "enhanced city involvement in decision-making.",
                                           ranges: [{
                                                      "start" => "/p[3]",
                                                      "startOffset" => 657,
                                                      "end" => "/p[3]",
    ...
    image = Rack::Test::UploadedFile.new(Rails.root.join("db", "demo_seeds", "images", "legislation", "processes", "opening.jpg"))
    ...
    image = Rack::Test::UploadedFile.new(Rails.root.join("db", "demo_seeds", "images", "legislation", "processes", "first-phase.jpg"))
    milestone.image = Image.create!({
      imageable: milestone,
      title: milestone.title,
      attachment: image,
