...
section "Creating DEMO SDG homepage cards" do
  card = Widget::Card.create!(cardable: SDG::Phase.first,
                              ...
                              description: "Submit your citizen proposal. Organize a community around " \
                                           "your proposal, find the support of your neighbors and when " \
                                           "you have enough support, your proposal will be debated in " \
                                           "the municipal plenary.",
                              link_url: "/proposals",
  ...
  card.image = Image.create!(imageable: card,
                             title: card.title,
                             attachment: demo_seed_image_attachment("polls/light-of-the-city-1.jpg"),
                             user_id: 1)

  card = Widget::Card.create!(cardable: SDG::Phase.third,
                              title: "Comment the plan for a 100% green city",
                              description: "Inform yourself and comment on the proposal about " \
                                           "the plan for a 100% green city",
  ...
  card.image = Image.create!(imageable: card,
                             title: card.title,
                             attachment: demo_seed_image_attachment(
                               "proposals/strategic-plan-for-a-100-green-city.jpg"
                             ),
                             user_id: 1)
end
