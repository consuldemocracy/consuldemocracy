section "Creating DEMO Debates" do
  ...
  debate = Debate.create!(
    ...
    description: <<~DESCRIPTION,
      <p>Glad to answer your questions about city pollution.</p>\r\n\r\n<p>\r\nI introduce
  ...
  comment = debate.comments.create!(body: "Can light pollution be considered as a type of " \
                                          "pollution? thank you very much.",
                                    user_id: 3,
                                    created_at: 1.month.ago)
  ...
  comment = debate.comments.create!(body: "How is pollution measured in the city? Are the " \
                                          "sensors really distributed in a representative way?",
                                    user_id: 4,
  ...
  comment = debate.comments.create!(body: "I would like to know if the closure of the city " \
                                          "centre to private traffic would have a major impact " \
                                          "on pollution or not so relevant?",
                                    user_id: 6,
  ...
  comment = debate.comments.create!(body: "According with this study of the city university it " \
                                          "would have an impact around the 40%: https://goog.gl/dfX45dds",
                                    user_id: admin.id,
  ...
  debate = Debate.create!(
    ...
    description: <<~DESCRIPTION,
      <p>One of the most powerful CO2 sinks and pollution filter are forests and trees.
      ...
      landscape restoration, among other benefits.</p>\r\n\r\n<p>However, there are people who
      think that this is too expensive and it would be better to look for other ways to reduce
      pollution. What do you think?</p>\r\n\r\n
    DESCRIPTION
  ...
  comment = debate.comments.create!(body: "This sounds too expensive. What other proposals could " \
                                          "be thought but much cheaper?",
                                    user_id: 8,
                                    created_at: 1.week.ago)
  ...
  comment = debate.comments.create!(body: "It's a perfect idea. It would create a natural " \
                                          "retaining wall of pollution",
                                    user_id: 9,
  ...
  debate = Debate.create!(
    ...
    description: <<~DESCRIPTION,
      <p>The streets and squares of the city have become hard: only cement, without fountains,
  ...
  comment = debate.comments.create!(body: "The good thing about cement squares is that they " \
                                          "make it possible to create punctual installations, " \
                                          "for example for cultural or leisure purposes. I think " \
                                          "it would be appropriate to prioritize this type of " \
                                          "facilities rather than just the terraces of bars or " \
                                          "establishments.",
                                    user_id: 7,
                                    created_at: 1.day.ago)
  ...
  debate = Debate.create!(
    ...
    title: "Rental prices",
    description: <<~DESCRIPTION,
      <p>Over the last couple of years, the weight of rents has increased dramatically, although
      the number of tourists walking around the city has also increased.</p>\r\n\r\n<p>It is
      ...
      claim.</p>\r\n\r\n<p>Does anyone have sufficiently comprehensive sources of information on
      this issue to resolve it?</p>\r\n\r\n<p></p>\r\n
    DESCRIPTION
  ...
  comment = debate.comments.create!(body: "I believe that tourist rental is positive, provided " \
                                          "that it is not monopolised and is carried out in a " \
                                          "decentralised manner and on a small scale.",
                                    user_id: 3,
                                    created_at: 1.hour.ago)
  up_voters = users.sample(5)
  up_voters.each do |voter|
  ...
  comment = debate.comments.create!(body: "I totally agree. It would be necessary to limit the " \
                                          "maximum tenancy of apartments per person.",
                                    user_id: 4,
                                    ancestry: Comment.last.id,
  ...
  debate = Debate.create!(
    ...
    description: <<~DESCRIPTION,
      <p>This is a debate that has been going on for a long time and it is the possibility of
      opening the metro on weekends at night. It would be important to know if it is a positive
      measure or too expensive for what it reports to the city.</p>\r\n\r\n<p>We do not need too
      high a frequency, but we do not need more than 20 minutes, because if we had to change
      trains, it would drive many people back. It would be interesting,</p>\r\n\r\n<p>if someone
  ...
  comment = debate.comments.create!(body: "It would be necessary to study the frequency of " \
                                          "displacements at night. It is not clear to me that " \
                                          "the number of people is relevant.",
                                    user_id: 11,
