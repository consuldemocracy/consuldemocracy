...
Setting['feature.debates'] = false                            if Setting["url"].nil?
Setting['feature.signature_sheets'] = false                   if Setting["url"].nil?
Setting['feature.proposals'] = false                          if Setting["url"].nil?
Setting['feature.legislation'] = false                        if Setting["url"].nil?
Setting['feature.polls'] = false                              if Setting["url"].nil?
