section "Creating Settings" do
  ...
  Setting.create(key: 'Documents maximum number for proposals', value: '3' )
  Setting.create(key: 'Documents maximum size (in Mb) for proposals', value: '3')
  Setting.create(key: 'Accepted content type for proposals', value: 'application/pdf')
  Setting.create(key: 'Documents maximum number for budget investments', value: '3')
  Setting.create(key: 'Documents maximum size (in Mb) for budget investments', value: '3')
  Setting.create(key: 'Accepted content type for budget investments', value: 'application/pdf')
  Setting.create(key: 'Documents maximum number for budget investment milestones', value: '3')
  Setting.create(key: 'Documents maximum size (in Mb) for budget investments milestones', value: '3')
  Setting.create(key: 'Accepted content type for budget investment milestones', value: 'application/pdf')
  Setting.create(key: 'Documents maximum number for legislation process', value: '3')
  Setting.create(key: 'Documents maximum size (in Mb) for legislation process', value: '3')
  Setting.create(key: 'Accepted content type for legislation process', value: 'application/pdf')
  Setting.create(key: 'Documents maximum number for poll question answers', value: '3')
  Setting.create(key: 'Documents maximum size (in Mb) for poll question answers',value: '3')
  Setting.create(key: 'Accepted content type for poll question answers', value: 'application/pdf')
