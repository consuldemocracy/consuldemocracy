section "Creating Settings" do
  ...
  Setting.create(key: "remote_census_general.endpoint", value: "census_api_endpoint")
  Setting.create(key: "remote_census_request.method_name", value: "get_habita_datos")
  Setting.create(key: "remote_census_request.structure", value: "{ request: { codigo_institucion: 1, codigo_portal: 1, codigo_usuario: 1, documento: 'xxx', tipo_documento: 'xxx', codigo_idioma: '102', nivel: '3' } }")
  Setting.create(key: "remote_census_request.alias_document_type", value: "request.tipo_documento")
  Setting.create(key: "remote_census_request.alias_document_number", value: "request.documento")
  Setting.create(key: "remote_census_request.alias_date_of_birth", value: "")
  Setting.create(key: "remote_census_request.alias_postal_code", value: "")
  Setting.create(key: "remote_census_response.date_of_birth", value: "get_habita_datos_response.get_habita_datos_return.datos_habitante.item.fecha_nacimiento_string")
  Setting.create(key: "remote_census_response.postal_code", value: "get_habita_datos_response.get_habita_datos_return.datos_vivienda.item.codigo_postal")
  Setting.create(key: "remote_census_response.district", value: "get_habita_datos_response.get_habita_datos_return.datos_vivienda.item.codigo_distrito")
  Setting.create(key: "remote_census_response.gender", value: "get_habita_datos_response.get_habita_datos_return.datos_habitante.item.descripcion_sexo")
  Setting.create(key: "remote_census_response.name", value: "get_habita_datos_response.get_habita_datos_return.datos_habitante.item.nombre")
  Setting.create(key: "remote_census_response.surname", value: "get_habita_datos_response.get_habita_datos_return.datos_habitante.item.apellido1")
  Setting.create(key: "remote_census_response.valid", value: "get_habita_datos_response.get_habita_datos_return.datos_habitante.item")
end
