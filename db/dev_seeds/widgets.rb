section "Creating header and cards for the homepage" do
  ...
  Widget::Card.create!(
    ...
    description_en: "Anyone can open threads on any subject, creating separate spaces where "\
                    "people can discuss the proposed topic. Debates are valued by everybody, "\
    ...
    description_es: "Cualquiera puede iniciar un debate sobre cualquier tema, creando un espacio "\
                    "separado donde compartir puntos de vista con otras personas. Los debates "\
                    "son valorados por todos para destacar los temas más importantes.",
  ...
  Widget::Card.create!(
    ...
    description_en: "Participatory budgets allow citizens to propose and decide directly how "\
                    "to spend part of the budget, with monitoring and rigorous evaluation of "\
                    "proposals by the institution. Maximum effectiveness and control with "\
                    "satisfaction for everyone.",
    description_es: "Los presupuestos participativos permiten que los ciudadanos propongan "\
                    "y decidan directamente cómo gastar parte del presupuesto, con la "\
                    "supervisión y valoración de la institución. Máxima eficacia y control "\
