...
describe "Poll Votation Type" do
  ...
  scenario "Unique and multiple with custom text options" do
    create(:poll_question_unique, :yes_no_custom_text, poll: poll, title: "Is it that bad?")
    ...
    within_fieldset("Is it that bad?") do
      ...
      fill_in "Answer for Yes", with: "because yes"
      ...
      expect(page).to have_field "Answer for Yes", type: :textarea, disabled: false, with: "because yes"
    end
