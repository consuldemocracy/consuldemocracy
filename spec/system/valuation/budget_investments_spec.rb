...
describe "Valuation budget investments" do
  ...
  describe "Valuate" do
    ...
    context "Reopen valuation" do
      ...
      scenario "Admins can reopen & modify finished valuation", :consul do
        logout
        login_as(admin.user)
        visit edit_valuation_budget_budget_investment_path(budget, investment)
      ...
      scenario "Valuators that are not admins cannot reopen or modify a finished valuation", :consul do
        visit edit_valuation_budget_budget_investment_path(budget, investment)
