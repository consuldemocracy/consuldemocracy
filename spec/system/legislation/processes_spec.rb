...
describe "Legislation" do
  ...
  context "processes home page" do
    ...
    scenario "Participation phases are displayed only if there is a phase enabled", :consul do
    ...
    scenario "Show SDG tags when feature is enabled", :consul do
  ...
  context "process page" do
    context "show" do
      ...
      scenario "do not show additional info button if it is empty", :consul do
        process = create(:legislation_process)
