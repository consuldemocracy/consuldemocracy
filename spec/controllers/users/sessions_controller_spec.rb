...
describe Users::SessionsController do
  ...
  describe "after_sign_in_path_for" do
    context "multitenancy_management_mode" do
      it "redirect to account path when multitenancy_management_mode is enabled and user is not an admin" do
      ...
      it "redirect to welcome path when multitenancy_management_mode is disabled" do
