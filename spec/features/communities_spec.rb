...
describe 'Communities' do
  ...
  context 'Show' do
    ...
    it 'displays without_topics_text and participants when there are not topics' do
      proposal = create(:proposal)
      community = proposal.community
    ...
    it 'displays order selector and topic content when there are topics' do
      proposal = create(:proposal)
      community = proposal.community
    ...
    it "orders by newest when order param is invalid" do
      proposal = create(:proposal)
      community = proposal.community
      topic1 = create(:topic, community: community)
      topic2 = create(:topic, community: community)
    ...
    it 'displays topic edit button on topic show when author is logged' do
      proposal = create(:proposal)
      community = proposal.community
      user = create(:user)
    ...
    it 'displays participant when there is topics' do
      proposal = create(:proposal)
      community = proposal.community
      topic = create(:topic, community: community)
    ...
    it 'displays participants when there are topics and comments' do
      proposal = create(:proposal)
      community = proposal.community
      topic = create(:topic, community: community)
    ...
    it 'redirects root path when communities are disabled' do
      Setting['feature.community'] = nil
      proposal = create(:proposal)
      community = proposal.community
    ...
    it "Accesing a community without associated communitable" do
      proposal = create(:proposal)
      community = proposal.community
