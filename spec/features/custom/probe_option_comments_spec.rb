...
feature 'Commenting Probe Options' do
  ...
  scenario 'Show' do
    parent_comment = create(:comment, commentable: probe_option)
    first_child    = create(:comment, commentable: probe_option, parent: parent_comment)
    second_child   = create(:comment, commentable: probe_option, parent: parent_comment)
  ...
  scenario 'Collapsable comments', :js do
    parent_comment = create(:comment, body: "Main comment", commentable: probe_option)
    child_comment  = create(:comment, body: "First subcomment", commentable: probe_option, parent: parent_comment)
    grandchild_comment = create(:comment, body: "Last subcomment", commentable: probe_option, parent: child_comment)
  ...
  scenario 'Comment order' do
    c1 = create(:comment, :with_confidence_score, commentable: probe_option, cached_votes_up: 100, cached_votes_total: 120, created_at: Time.now - 2)
  ...
  scenario 'Creation date works differently in roots and in child comments, even when sorting by confidence_score' do
    old_root = create(:comment, commentable: probe_option, created_at: Time.now - 10)
    new_root = create(:comment, commentable: probe_option, created_at: Time.now)
  ...
  scenario 'Turns links into html links' do
    create :comment, commentable: probe_option, body: 'Built with http://rubyonrails.org/'
  ...
  scenario 'Sanitizes comment body for security' do
    create :comment, commentable: probe_option, body: "<script>alert('hola')</script> <a href=\"javascript:alert('sorpresa!')\">click me<a/> http://www.url.com"
  ...
  scenario 'Paginated comments' do
    per_page = 10
    (per_page + 2).times { create(:comment, commentable: probe_option)}
  ...
  scenario 'Create', :js do
    ...
    fill_in "comment-body-probe_option_#{probe_option.id}", with: 'Have you thought about...?'
  ...
  scenario 'Reply', :js do
    ...
    comment = create(:comment, commentable: probe_option, user: citizen)
  ...
  scenario 'Errors on reply', :js do
    comment = create(:comment, commentable: probe_option, user: user)
  ...
  scenario "N replies", :js do
    parent = create(:comment, commentable: probe_option)

    7.times do
      create(:comment, commentable: probe_option, parent: parent)
  ...
  scenario 'Submit button is disabled after clicking', :js do
    ...
    fill_in "comment-body-probe_option_#{probe_option.id}", with: 'Testing submit button!'
    click_button 'Publish comment'
  ...
  feature "Moderators" do
    scenario "can create comment as a moderator", :js do
      ...
      fill_in "comment-body-probe_option_#{probe_option.id}", with: "I am moderating!"
      check "comment-as-moderator-probe_option_#{probe_option.id}"
      click_button "Publish comment"
  ...
  feature "Administrators" do
    scenario "can create comment as an administrator", :js do
      ...
      fill_in "comment-body-probe_option_#{probe_option.id}", with: "I am your Admin!"
      check "comment-as-administrator-probe_option_#{probe_option.id}"
      click_button "Publish comment"
