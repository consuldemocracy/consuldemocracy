...
feature "Admin custom pages" do
  ...
  context "Update" do
    scenario "Valid custom page" do
      create(:site_customization_page, slug: "example-page")
      visit admin_root_path
      ...
      click_link "example-page"

      expect(page).to have_field("site_customization_page[slug]", with: "example-page")

      fill_in "site_customization_page_slug", with: "another-example-page"
      
      click_button "Update Custom page"

      expect(page).to have_content "Page updated successfully"
      expect(page).to have_content "another-example-page"
    end
  end
