...
describe SDG::Goal do
  ...
  it "is not valid with an already used title" do
    create(:sdg_goal, title: "World domination")

    duplicate = build(:sdg_goal, title: "World domination")
    duplicate.save
  ...
  it "is valid with the same title for a different locale" do
    create(:sdg_goal, title: "Smarter dolphins")

    I18n.with_locale(:es) do
      goal = build(:sdg_goal, title: "Smarter dolphins")
