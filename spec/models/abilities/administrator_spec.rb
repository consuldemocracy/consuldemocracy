...
describe Abilities::Administrator do
  ...
  let(:future_poll_question_essay) { create(:poll_question_essay, poll: future_poll) }
  let(:future_poll_question_option_essay) do
    create(:poll_question_option, question: future_poll_question_essay)
  end
  ...
  it { should_not be_able_to(:create,  future_poll_question_option_essay) }
  it { should_not be_able_to(:update,  future_poll_question_option_essay) }
  it { should_not be_able_to(:destroy, future_poll_question_option_essay) }
