...
describe Poll::Answer do
  describe "validations" do
    ...
    it "is valid without answer text when an option is present" do
      answer.option = answer.question.question_options.sample
      answer.answer = nil
    ...
    it "is valid without answer text when option allows custom text" do
      question = create(:poll_question, :yes_no_custom_text)
      option = question.question_options.first

      answer = build(:poll_answer, question: question, option: option, answer: nil)
    ...
    it "is not valid when answer exceeds maximum length" do
      question = create(:poll_question_open)
      answer = build(:poll_answer, question: question, answer: "a" * 1001)
    ...
    it "is valid when answer is at maximum length" do
      question = create(:poll_question_open)
      answer = build(:poll_answer, question: question, answer: "a" * 1000)
