...
describe Polls::Questions::QuestionComponent do
  ...
  context "Verified user" do
    ...
    it "renders radio buttons for single-choice questions" do
      ...
      expect(page).to have_field "Yes", type: :text
      expect(page).to have_field "No", type: :radio
      expect(page).not_to have_field "No", type: :text
    ...
    it "selects the option when users have already voted" do
      option_yes.update!(open_text: true)
      create(:poll_answer, author: user, question: question, option: option_yes, text_answer: "because yes")
