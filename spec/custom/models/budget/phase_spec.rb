...
describe Budget::Phase do
  ...
  describe "validates" do
    ...
    describe "#prev_phase_dates_valid?" do
      ...
      xit "is invalid when start date is same as previous enabled phase start date" do
      ...
      # TODO i18n : broken because of test locale change
      xit "is invalid when start date is earlier than previous enabled phase start date" do
    ...
    describe "#next_phase_dates_valid?" do
      ...
      # TODO i18n : broken because of test locale change
      xit "is invalid when end date is same as next enabled phase end date" do
      ...
      # TODO i18n : broken because of test locale change
      xit "is invalid when end date is later than next enabled phase end date" do
