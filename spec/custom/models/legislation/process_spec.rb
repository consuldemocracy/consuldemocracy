...
describe Legislation::Process do
  ...
  describe "dates validations" do
    xit "is invalid if debate_start_date is present but debate_end_date is not" do
    ...
    xit "is invalid if debate_end_date is present but debate_start_date is not" do
    ...
    xit "is invalid if allegations_start_date is present but debate_end_date is not" do
    ...
    xit "is invalid if debate_end_date is present but allegations_start_date is not" do
  ...
  describe "date ranges validations" do
    ...
    xit "is invalid if debate_end_date is before debate start_date" do
    ...
    xit "is invalid if allegations_end_date is before allegations_start_date" do
