...
describe SignatureSheet do
  ...
  describe "#name" do
    xit "returns name for proposal signature sheets" do
    ...
    xit "returns name for spending proposal signature sheets" do
    ...
    xit "returns name for budget investment signature sheets" do
