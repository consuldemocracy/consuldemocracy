...
feature 'Proposal Notifications' do
  ...
  xscenario "Send a notification (Active voter)" do
    author = create(:user)
    proposal = create(:proposal, author: author)
  ...
  xscenario "Send a notification (Follower)" do
    author = create(:user)
    proposal = create(:proposal, author: author)
  ...
  xscenario "Send a notification (Follower and Voter)" do
    author = create(:user)
    proposal = create(:proposal, author: author)
  ...
  xscenario "Send a notification (Blocked voter)" do
    author = create(:user)
    proposal = create(:proposal, author: author)
  ...
  xscenario "Send a notification (Erased voter)" do
    author = create(:user)
    proposal = create(:proposal, author: author)
