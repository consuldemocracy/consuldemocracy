shared_examples "flaggable" do |factory_name, admin: false|
  ...
  scenario "Flagging as inappropriate" do
    ...
    within "##{dom_id(flaggable)} .flag-content" do
      click_button "upper-flag-button"
      click_button "lower-flag-button"

      expect(page).to have_button "Unflag"
      expect(page).to have_button "lower-unflag-button", visible: :hidden
  ...
  scenario "Unflagging" do
    ...
    within "##{dom_id(flaggable)} .flag-content" do
      ...
      click_button "upper-unflag-button"
      click_button "lower-unflag-button"

      expect(page).not_to have_button "Unflag"
      expect(page).to have_button "lower-flag-button", visible: :hidden
