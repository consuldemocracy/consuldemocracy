  ...
  def create
    ...
    ["1", "2", "3"].each do |document_type|
      ...
      if @residence.save
        ...
        if @residence.postal_code.blank? && @residence.call_census_api.valid?
        ...
        elsif @residence.errors[:year_of_birth].present? || @residence.errors[:residence_in_madrid].present?
