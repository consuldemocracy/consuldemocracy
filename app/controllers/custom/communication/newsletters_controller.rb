class Communication::NewslettersController < Communication::BaseController
  ...
  def create
    ...
    if @newsletter.save
      ...
      redirect_to [:communication, @newsletter], notice: notice
    else
      render :new
    end
  end
  ...
  def update
    ...
    if @newsletter.update(newsletter_params)
      redirect_to [:communication, @newsletter], notice: t("admin.newsletters.update_success")
    else
      render :edit
    end
  end
  ...
  def destroy
    ...
    redirect_to communication_newsletters_path, notice: t("admin.newsletters.delete_success")
  end
