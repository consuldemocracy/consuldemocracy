  ...
  private
    ...
    def budget_investment_params
      params.require(:budget_investment)
            .permit(:title, :description, :external_url, :heading_id, :organization_name, :tag_list, :label, :administrator_id, :valuation_tag_list, :visible_to_valuators, valuator_ids: [])
    end
