module Types
  class ProposalType < Types::BaseObject
    ...
    connection_field :comments, Types::CommentType, null: true
    ...
    connection_field :proposal_notifications, Types::ProposalNotificationType, null: true
    ...
    connection_field :tags, Types::TagType, null: true
    field :title, String, null: true
    field :video_url, String, null: true
    connection_field :votes_for, Types::VoteType, null: true
    connection_field :milestones, Types::MilestoneType, null: true
