module Types
  class QueryType < Types::BaseObject
    ...
    id_field :budget, Types::BudgetType, "Returns budget for ID", null: false

    field :comments, Types::CommentType.connection_type, "Returns all comments", null: false
    id_field :comment, Types::CommentType, "Returns comment for ID", null: false

    field :debates, Types::DebateType.connection_type, "Returns all debates", null: false
    id_field :debate, Types::DebateType, "Returns debate for ID", null: false

    field :geozones, Types::GeozoneType.connection_type, "Returns all geozones", null: false
    id_field :geozone, Types::GeozoneType, "Returns geozone for ID", null: false

    field :milestones, Types::MilestoneType.connection_type, "Returns all milestones", null: false
    id_field :milestone, Types::MilestoneType, "Returns milestone for ID", null: false

    field :proposals, Types::ProposalType.connection_type, "Returns all proposals", null: false
    id_field :proposal, Types::ProposalType, "Returns proposal for ID", null: false
    ...
    id_field :proposal_notification,
    ...
    id_field :tag, Types::TagType, "Returns tag for ID", null: false

    field :users, Types::UserType.connection_type, "Returns all users", null: false
    id_field :user, Types::UserType, "Returns user for ID", null: false

    field :votes, Types::VoteType.connection_type, "Returns all votes", null: false
    id_field :vote, Types::VoteType, "Returns vote for ID", null: false
