module VerificationHelper
  ...
  def document_types
    [[t('verification.residence.new.document_type.spanish_id'), "dni"],
     [t('verification.residence.new.document_type.passport'), "passport"],
     [t('verification.residence.new.document_type.residence_card'), "nie"]]
  end
