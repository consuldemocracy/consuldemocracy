class Comment < ActiveRecord::Base
  ...
  validates_inclusion_of :commentable_type, in: ["Debate", "Proposal", "ProbeOption", "SpendingProposal", "Poll::Question", "Budget::Investment", "Legislation::Question", "Legislation::Annotation"]
