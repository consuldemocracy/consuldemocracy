class Comment < ActiveRecord::Base
  ...
  validates :commentable_type, inclusion: { in: ["Debate", "Proposal", "SpendingProposal", "ProbeOption", "Budget::Investment", "Poll::Question", "Legislation::Question", "Legislation::Annotation"] }
