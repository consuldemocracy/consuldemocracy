class Poll::Question::Answer < ActiveRecord::Base
  ...
  def self.max_documents_allowed
    Setting["poll_question_answer_max_documents_allowed"].to_i
  end

  def self.max_file_size
    Setting["poll_question_answer_max_file_size"].to_i.megabytes
  end

  def self.accepted_content_types
    [Setting["poll_question_answer_accepted_content_types"]]
  end
