class Budget
  class Investment < ActiveRecord::Base
    ...
    def self.max_documents_allowed
      Setting["budget_investment_max_documents_allowed"].to_i
    end

    def self.max_file_size
      Setting["budget_investment_max_file_size"].to_i.megabytes
    end

    def self.accepted_content_types
      [Setting["budget_investment_accepted_content_types"]]
    end
