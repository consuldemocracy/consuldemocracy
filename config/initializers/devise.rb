...
Devise.setup do |config|
  ...
  config.omniauth :openid_connect, name: :oidc, scope: [:openid, :email, :profile], response_type: :code,
                                   issuer: Rails.application.secrets.oidc_issuer, discovery: true, client_auth_method: :basic,
                                   client_options: {
