namespace :dashboards do
  ...
  task create_basic_dashboard_actions_template: :environment do
    ...
    Dashboard::Action.create(title: "Elige un título corto, potente y llamativo",
                             ...
                             active: true,
                             action_type: 0,
                             short_description: "Sé conciso y directo para que tu propuesta se entienda al instante",
                             published_proposal: false)
    ...
    Dashboard::Action.create(title: "Suma en tu propósito a los negocios de tu barrio",
                             ...
                             active: true,
                             action_type: 0,
                             short_description: "¿Has pensado en hablar con los bares o comercios que más visitas?",
                             published_proposal: false)
    ...
    Dashboard::Action.create(title: "Suma en tu propósito a ONGs o centros sociales de tu barrio",
                             ...
                             active: true,
                             action_type: 0,
                             short_description: "Cuéntales tu propuesta a todos los que pueda interesarles",
                             published_proposal: false)
    Dashboard::Action.create(title: "¿Conoces a algún influencer?",
                             ...
                             active: true,
                             action_type: 0,
                             short_description: "Cuéntale tu propuesta y consigue que él y sus seguidores te apoyen",
                             published_proposal: false)
    ...
    Dashboard::Action.create(title: "Informa de tus planes antes de la publicación",
                             ...
                             active: true,
                             action_type: 0,
                             short_description: "Todos en redes sociales deben saber que pronto crearás tu propuesta. ",
                             published_proposal: false)
    Dashboard::Action.create(title: "Comparte tu propuesta en comunidades de facebook",
                             ...
                             active: true,
                             action_type: 0,
                             short_description: "¿Sabes a cuántas personas podrías llegar con estos grupos?",
                             published_proposal: false)
    Dashboard::Action.create(title: "Analiza con detenimiento otras propuestas",
                             ...
                             active: true,
                             action_type: 0,
                             short_description: "Antes de publicar tu propuesta, mira cómo lo han hecho otros",
                             published_proposal: false)
    Dashboard::Action.create(title: "Utiliza whatsapp para difundir ",
                             ...
                             active: true,
                             action_type: 0,
                             short_description: "Whatsapp o su equivalente Telegram son grandes herramientas para conseguir apoyos instantáneos.",
    ...
    Dashboard::Action.create(title: "Utiliza tus redes sociales",
                             ...
                             active: true,
                             action_type: 0,
                             short_description: "Copia y pega el enlace de tu propuesta en tus perfiles sociales.",
                             published_proposal: true)
    Dashboard::Action.create(title: "Continúa pidiendo apoyo a nuevos embajadores de tu propuesta",
                             ...
                             active: true,
                             action_type: 0,
                             short_description: "Comercios, negocios locales, Centros Sociales, Colectivos...",
                             published_proposal: true)
    ...
    Dashboard::Action.create(title: "Aplica las acciones que tienes pendientes",
                             ...
                             active: true,
                             action_type: 0,
                             short_description: "Encontrarás todas las acciones en la página de \"Acciones recomendadas\" en tu Panel de Propuesta. Recuerda utilizarlas habitualmente para lograr nuevos apoyos.",
                             published_proposal: true)
    ...
    Dashboard::Action.create(title: "Imprime tu propuesta y repártela",
                             ...
                             active: true,
                             action_type: 0,
                             short_description: "La gente confía más cuando tiene información suficiente",
                             published_proposal: true)
    Dashboard::Action.create(title: "Crea tarjetas de visita adaptándolas  para difundir tu propuesta",
                             ...
                             active: true,
                             action_type: 0,
                             short_description: "Es una manera directa y diferente de llegar a más gente",
                             published_proposal: true)
    Dashboard::Action.create(title: "Pide que te apoyen en tu trabajo",
                             ...
                             active: true,
                             action_type: 0,
                             short_description: "Apóyate en tus compañeros y compañeras de trabajo, ¡son cruciales!",
                             published_proposal: true)
    ...
    Dashboard::Action.create(title: "Mención en RRSS del Ayuntamiento",
                             ...
                             active: true,
                             action_type: 1,
                             short_description: "Una difusión específica en las redes del Ayuntamiento",
                             published_proposal: true)
