...
![Formulario para crear un registro rellenando el tipo de documento, el número de documento, la fecha de nacimiento y el código postal](../.gitbook/assets/add-local-census-record-es.png)
...
![Página para importar nuevos registros a través de un csv](../.gitbook/assets/add-local-census-records-csv-es.png)
