...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/d9LWVG9gklmB6Mj632co/getting_started/create
---
...
3. [Fork Consul Democracy](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/fork-a-repo) using the **fork** button on the top right corner at [https://github.com/consuldemocracy/consuldemocracy](https://github.com/consuldemocracy/consuldemocracy)
