...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/d9LWVG9gklmB6Mj632co/features/local_census
---
...
![Form to create a record by filling in the document type, document number, date of birth and postal code](../.gitbook/assets/add-local-census-record-en.png)
...
![Page to import new records via csv](../.gitbook/assets/add-local-census-records-csv-en.png)
