...
You can configure authentication services with external OAuth providers. Right now, Twitter, Facebook, Google, Wordpress, SAML and OIDC are supported.
...
```yml
  ...
  oidc_redirect_uri: "https://yourapp.com/auth/oidc/callback"
```
